...
import (
	"context"
	relation "douyin_rpc/server/cmd/api/kitex_gen/relation"
...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetCount":     kitex.NewMethodInfo(getCountHandler, newRelationServiceGetCountArgs, newRelationServiceGetCountResult, false),
	}
...
func getCountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*relation.RelationServiceGetCountArgs)
	realResult := result.(*relation.RelationServiceGetCountResult)
	success, err := handler.(relation.RelationService).GetCount(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newRelationServiceGetCountArgs() interface{} {
	return relation.NewRelationServiceGetCountArgs()
}

func newRelationServiceGetCountResult() interface{} {
	return relation.NewRelationServiceGetCountResult()
}
...
func (p *kClient) GetCount(ctx context.Context, req *relation.GetCountRequest) (r *relation.GetCountResponse, err error) {
	var _args relation.RelationServiceGetCountArgs
	_args.Req = req
	var _result relation.RelationServiceGetCountResult
